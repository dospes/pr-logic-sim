 ...
 * Details der Ein-/Ausgabe von Java vertraut sein müssen.
 * 
 * Für die Neugierigen: Diese Klasse benutzt einen FileReader zum Lesen aus
 * der Datei und einen BufferedReader zum Puffern der Eingaben und zum Zerlegen
 * in Zeilen.
 *
 * Wenn Sie eine nicht existente oder für Sie nicht zugreifbare Datei lesen
 * wollen, dann wirkt das so als hätten Sie eine leere Datei versucht zu lesen
 *
...
public class DateiLeser
{
     ...
     * @param dateiname ist ein String, der den Dateinamen beschreibt. Sollte
     *        ein Pfad erforderlich sein, um auf die Datei zuzugreifen, dann muss
     *        dieser Pfad mit im String enthalten sein und sollte dann den
     *        Betriebssystem Konventionen genügen. Beispiele:
     *        <UL><LI>DateiLeser("Schaltung.txt")</LI>
     *        <LI>DateiLeser("C:\Temp\inputs.liste");</LI></UL>
     */
	...
	if (!lesenVersucht) leseVersuch();
	return (gelesenerString!=null);
    }

    /**
     * Gib die nächste Zeile der Datei als String zurück. Wenn keine Zeile mehr
